...
public class MqttServerOptions extends NetServerOptions {
  ...
  // max message size (total MQTT packet including fixed header) in bytes
   ...
   *
   * @param maxMessageSize  max MQTT message size (total packet size including fixed header)
  ...
  /**
   * @return  max MQTT message size (total packet size including fixed header)
   */
